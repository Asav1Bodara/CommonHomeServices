<%@ Page Title="" Language="C#" MasterPageFile="~/BeforeLogin.master" AutoEventWireup="true" CodeFile="ServiceProviderSignUp.aspx.cs" Inherits="ServiceProviderSignUp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       ...
       <tr>
          ...
          <td> <asp:LinkButton OnClick="btn" ID="btnLink" ForeColor="white" runat="server">Don't have licence?</asp:LinkButton></td>
           ...
           <asp:Panel Visible="false" ID="Panel2" runat="server">
             <tr>
               <th><strong>
                Driver's Licence:</strong> 
               </th>
               <td>
                 <asp:TextBox ID="txtDriverLic" Placeholder="Enter licence with out -" runat="server"></asp:TextBox>
               </td>
             </tr>
             <tr>
               <th><strong>
               ...
               <td>
                 <asp:TextBox ID="txtReferences" Placeholder="Enter references" runat="server"></asp:TextBox>
               </td>
             </tr>
           </asp:Panel>
           <tr>
            ...
            <td>
            <asp:DropDownList Placeholder="Select Your Service" ID="ddlProviderType" runat="server" DataSourceID="SqlDataSource1" DataTextField="SPType" DataValueField="SPTypeId"></asp:DropDownList>
        ...
        <asp:ValidationSummary ID="ValidationSummary1" runat="server"></asp:ValidationSummary>
					...
					<div class="container-login100-form-btn p-t-10">
						<asp:Button class="login100-form-btn" ID="btnLogin" runat="server" Text="Send Request" OnClick="btnLogin_Click"  />              
