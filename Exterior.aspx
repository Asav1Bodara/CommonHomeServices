<%@ Page Title="" Language="C#" MasterPageFile="~/AfterLogin.master" AutoEventWireup="true" CodeFile="Exterior.aspx.cs" Inherits="Exterior" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Exterior Service Providers</title>
    <style>
        .button {
            ...
            <section class="content">
                <div class="container-fluid">
                  <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString1 %>" SelectCommand="SELECT [SPID],[SPStoreName], [SPName], [SPPhone], [SPAddress], [SPEmail], [SPType] FROM [viewServiceProvider] WHERE ([SPType] = 'Exterior')">
